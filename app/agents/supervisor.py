"""
Supervisor Agent for CodeGuardian AI.
        ...
        if fixable:
            ...
            try:
                ...
                fix_comment = (
                    ...
                    f"**Review and merge manually** — CodeGuardian never auto-merges.\n\n"
...
def build_review_graph() -> StateGraph:
    """Build the CodeGuardian review pipeline as an explicit LangGraph graph.
...
def _build_pr_comment(
    ...
    lines = [
        "# 🛡️ CodeGuardian AI — Review Report",
        "",
    ...
    lines.extend([
        "---",
        f"*Generated by [CodeGuardian AI](https://github.com/{repo}) — Multi-Agent Code Review*",
    ])
